...
r = requests.Session()
header = { "User-Agent": "YouShaQi/2.25.1 (iPhone; iOS 10.3.1; Scale/2.00)", "X-User-Agent": "YouShaQi/2.25.1 (iPhone; iOS 10.3.1; Scale/2.00)" }
...
def get_top_book (): 
	...
	url1 = 'http://api.zhuishushenqi.com/v3/ranking/gender'
